...
cvar_t	*r_showMaximumHeight;
cvar_t	*r_showMaximumHeightColorR;
cvar_t	*r_showMaximumHeightColorG;
cvar_t	*r_showMaximumHeightColorB;
...
void R_SetShowMaxHeightColor_f(void)
{
	if (Cmd_Argc() != 4) {
		Com_Printf("Usage: r_showMaximumHeightColor <red 0-255> <green 0-255> <blue 0-255>\n");
		Com_Printf("Current color is: %d %d %d\n",
			r_showMaximumHeightColorR->integer,
			r_showMaximumHeightColorG->integer,
			r_showMaximumHeightColorB->integer);
		return;
	}
	Cvar_Set("r_showMaximumHeightColorR", Cmd_Argv(1));
	Cvar_Set("r_showMaximumHeightColorG", Cmd_Argv(2));
	Cvar_Set("r_showMaximumHeightColorB", Cmd_Argv(3));
}
...
extern qboolean Sys_LowPhysicalMemory();
	...
	r_showMaximumHeight = Cvar_Get("r_showMaximumHeight", "0", CVAR_ARCHIVE);
	r_showMaximumHeightColorR = Cvar_Get("r_showMaximumHeightColorR", "0", CVAR_ARCHIVE);
	r_showMaximumHeightColorG = Cvar_Get("r_showMaximumHeightColorG", "0", CVAR_ARCHIVE);
	r_showMaximumHeightColorB = Cvar_Get("r_showMaximumHeightColorB", "255", CVAR_ARCHIVE);
...
extern void R_ReloadFonts_f(void);
	...
	Cmd_AddCommand(	"showMaximumColor", R_SetShowMaxHeightColor_f );
...
refexport_t *GetRefAPI ( int apiVersion ) {
	...
	re.SetPlayerJumpForceLevel = RE_SetPlayerJumpForceLevel;
